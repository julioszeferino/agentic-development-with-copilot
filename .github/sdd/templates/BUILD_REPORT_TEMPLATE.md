...
**If Complete:** `/workflow_ship .github/sdd/features/DEFINE_{FEATURE_NAME}.md`

**If Blocked:** Resolve blockers, then `/workflow_build` to resume

**If Issues Found:** `/workflow_iterate DESIGN_{FEATURE}.md "{change needed}"`
