...
|---------|-------|---------|-------|
| `/workflow_brainstorm` | 0 | Explore ideas through collaborative dialogue | Opus |
| `/workflow_define` | 1 | Capture and validate requirements | Opus |
| `/workflow_design` | 2 | Create architecture and specification | Opus |
| `/workflow_build` | 3 | Execute implementation with verification | Sonnet |
| `/workflow_ship` | 4 | Archive with lessons learned | Haiku |
| `/workflow_iterate` | Any | Update documents when changes needed | Sonnet |
...
| `BUILD_REPORT_{FEATURE}.md` | 3 | `.github/sdd/reports/` |
| `SHIPPED_{DATE}.md` | 4 | `.github/sdd/archive/{FEATURE}/` |
...
/workflow_brainstorm "I want to build a user notification system"

# Phase 1: Define requirements (from brainstorm output)
/workflow_define .github/sdd/features/BRAINSTORM_USER_NOTIFICATIONS.md

# Phase 2: Create technical design
/workflow_design .github/sdd/features/DEFINE_USER_NOTIFICATIONS.md

# Phase 3: Build the code
/workflow_build .github/sdd/features/DESIGN_USER_NOTIFICATIONS.md

# Phase 4: Archive when complete
/workflow_ship .github/sdd/features/DEFINE_USER_NOTIFICATIONS.md
```
...
/workflow_define "Build a REST API for user management"

# Continue with /workflow_design → /workflow_build → /workflow_ship
```
...
/workflow_iterate BRAINSTORM_USER_AUTH.md "Consider using OAuth instead of custom tokens"

# Update DEFINE with new requirement
/workflow_iterate DEFINE_DATA_EXPORT.md "Add support for CSV format"

# Update DESIGN with architecture change
/workflow_iterate DESIGN_DATA_EXPORT.md "Components need to be self-contained"
```
...
| **Iterate Anywhere** | Changes can be made at any phase via `/workflow_iterate` |
...
| Resource | Location |
|----------|----------|
| Commands | `.github*/prompts/workflow_*` |
