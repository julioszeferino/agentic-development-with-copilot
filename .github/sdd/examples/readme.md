...
```text
/workflow_brainstorm "Deploy invoice extraction pipeline" → BRAINSTORM_*.md
         ↓
/workflow_define BRAINSTORM_*.md                         → DEFINE_*.md
         ↓
/workflow_design DEFINE_*.md                             → DESIGN_*.md
         ↓
/workflow_build DESIGN_*.md                              → Code + BUILD_REPORT_*.md
```
