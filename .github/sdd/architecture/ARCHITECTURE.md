...
│   [Optional]                                                                                            │
│                                                                                                          │
│   /workflow_brainstorm          /workflow_define              /workflow_design              /workflow_build               /workflow_ship             │
│        │                    │                    │                    │                    │            │
│        ▼                    ▼                    ▼                    ▼                    ▼            │
│   ┌──────────┐         ┌─────────┐          ┌─────────┐          ┌─────────┐          ┌─────────┐      │
│   │BRAINSTORM│────────▶│ DEFINE  │─────────▶│ DESIGN  │─────────▶│  BUILD  │─────────▶│  SHIP   │      │
...
.github/
├── prompts/
│       ├── workflow_brainstorm.prompt.md      # Phase 0 command (optional)
│       ├── workflow_define.prompt.md          # Phase 1 command
│       ├── workflow_design.prompt.md          # Phase 2 command
│       ├── workflow_build.prompt.md           # Phase 3 command
│       ├── workflow_ship.prompt.md            # Phase 4 command
│       ├── workflow_iterate.prompt.md         # Cross-phase update
│       └── workflow_create-pr.prompt.md       # Utility (unchanged)
│
├── agents/
│   └── workflow/
...
├─────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                          │
│                         /workflow_iterate DEFINE_*.md "change"                                   │
│                                      │                                                   │
│                                      ▼                                                   │
│                              ┌──────────────┐                                            │
│                              │ DETECT PHASE │                                            │
