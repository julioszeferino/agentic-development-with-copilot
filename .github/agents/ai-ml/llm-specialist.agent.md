...
tools: [read, edit, search, todo, web, context7/*, exa/*]
user-invocable: true
---
...
mcp_context7_get-library-docs({ context7CompatibleLibraryID: "{library-id}", topic: "{specific question about LLM prompt engineering}" })
```
