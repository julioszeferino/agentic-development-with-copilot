...
```text
.github/kb/python/           # Clean code patterns
.github/kb/supabase/         # The Ledger (Postgres)
.github/kb/qdrant/           # The Memory (Vector DB)
.github/kb/langfuse/         # LLMOps observability
.github/kb/testing/          # pytest patterns
```
...
mcp_context7_get-library-docs({ context7CompatibleLibraryID: "{library-id}", topic: "{specific question about data pipeline architecture}" })
```
