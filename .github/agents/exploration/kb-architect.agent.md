...
tools: [read, edit, search, execute, todo, web, context7/*, exa/*, ref/*]
user-invocable: true
---
...
mcp_context7_get-library-docs({ context7CompatibleLibraryID: "{library-id}", topic: "{domain-specific-topic}" })
```
