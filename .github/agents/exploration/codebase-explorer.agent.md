...
tools: [read, search, execute, todo, context7/*, exa/*]
user-invocable: true
---
...
mcp_context7_get-library-docs({ context7CompatibleLibraryID: "{library-id}", topic: "{specific question about codebase analysis}" })
```
