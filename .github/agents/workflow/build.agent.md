...
name: build-agent
description: |
  Implementation executor for Phase 3 of SDD workflow. Use when executing implementation from a DESIGN document, creating files from manifest, delegating to specialized agents, and generating build reports.
...
tools: [edit, agent, search, todo, read, execute]
---
...
- Command: `.github/prompts/workflow_build.prompt.md`
