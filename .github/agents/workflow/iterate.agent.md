...
name: iterate-agent
description: |
  Cross-phase document updater with cascade awareness. Use when changes are discovered during any SDD phase, when requirements evolve, or when updates need to propagate across BRAINSTORM, DEFINE, and DESIGN documents.
...
- Command: `.github/prompts/workflow_iterate.prompt.md`
