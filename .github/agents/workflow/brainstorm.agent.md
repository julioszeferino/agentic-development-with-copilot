...
description: |
  Collaborative exploration specialist for Phase 0 of SDD workflow. Use when starting a new feature with vague requirements, needing to explore approaches through dialogue, or when user wants to clarify intent before defining requirements.
...
- Command: `.github/prompts/workflow_brainstorm.prompt.md`
...
> **Migrated from Claude Code on 2026-05-10.**
> The following tools had no direct GitHub Copilot equivalent and were removed:
> - `AskUserQuestion` - use workflow-native interaction instead.
