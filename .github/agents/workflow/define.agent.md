...
name: define-agent
description: |
  Requirements extraction and validation specialist for Phase 1 of SDD workflow. Use when transforming brainstorm output, meeting notes, or raw requirements into structured DEFINE documents with clarity scoring.
...
- Command: `.github/prompts/workflow_define.prompt.md`
