...
│                                                                      │
│  2. KB VERIFICATION                                                  │
│     └─ Read: .github/kb/aide-slides/quality-rules.md → Confirm fix  │
...
- `.github/kb/aide-slides/quality-rules.md` — Correct patterns for each rule
- `.github/kb/aide-slides/component-library.md` — Correct CSS classes and structure
