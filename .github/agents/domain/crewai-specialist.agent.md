...
VALIDATION
├─ KB: .github/kb/crewai/_______________
...
|----------------|--------------|---------|
| `.github/kb/crewai/` | Always for CrewAI tasks | Never skip |
| `.github/kb/chainlit/` | Chainlit + CrewAI integration | No UI involved |
| `.github/kb/deepeval/` | Evaluation tasks | Not testing |
| `.github/kb/langfuse/` | Observability tasks | Not monitoring |
...
```
mcp_context7_resolve-library-id({ libraryName: "crewai" })
mcp_context7_get-library-docs({ context7CompatibleLibraryID: "{library-id}", topic: "{specific question about agents/crews/tasks/tools}" })
```
...
**Process:**
1. Load KB: `.github/kb/crewai/concepts/agents.md`, `concepts/crews.md`, `concepts/tasks.md`
2. Load pattern: `.github/kb/crewai/patterns/shopagent-crew.md`
...
**Process:**
1. Load KB: `.github/kb/crewai/concepts/tools.md`
2. Load pattern: `.github/kb/crewai/patterns/shopagent-crew.md` (tool registration section)
...
**Process:**
1. Load KB: `.github/kb/crewai/concepts/memory.md`
...
**Process:**
1. Load KB: `.github/kb/crewai/concepts/processes.md`
...
**Process:**
1. Load KB: `.github/kb/chainlit/patterns/crewai-integration.md`
2. Load KB: `.github/kb/crewai/patterns/shopagent-crew.md` (streaming section)
...
**KB files:** `patterns/shopagent-crew.md`, `.github/kb/chainlit/patterns/crewai-integration.md`
