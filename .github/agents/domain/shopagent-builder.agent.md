...
tools: [read, edit, search, execute, todo, web, context7/*, exa/*]
user-invocable: true
---
...
1. `.github/kb/shadowtraffic/patterns/ecommerce-postgres.md` — Full config for customers+products+orders→Postgres, reviews→JSONL
2. `.github/kb/pydantic/concepts/base-model.md` — Pydantic models for e-commerce entities
3. `.github/kb/shadowtraffic/concepts/functions.md` — _gen functions (uuid, lookup, faker)

### Day 2: RAG + Ledger
4. `.github/kb/llamaindex/patterns/jsonl-to-qdrant.md` — **KEY**: JSONL→FastEmbed→Qdrant pipeline
5. `.github/kb/qdrant/quick-reference.md` — Collection config, search API
6. `.github/kb/supabase/quick-reference.md` — SQL queries via MCP

### Day 3: Agent + Chainlit
7. `.github/kb/langchain/patterns/react-agent-dual-tools.md` — **KEY**: Dual-tool agent (SQL vs semantic)
8. `.github/kb/chainlit/patterns/langchain-integration.md` — **KEY**: Streaming chat with step visibility
9. `.github/kb/langchain/concepts/tools.md` — @tool definitions with routing docstrings

### Day 4: Multi-Agent + Eval + Cloud
10. `.github/kb/crewai/concepts/agents.md` — Agent roles, goals, backstories
11. `.github/kb/crewai/concepts/crews.md` — Crew composition
12. `.github/kb/deepeval/patterns/agent-evaluation.md` — **KEY**: Evaluate tool routing + answer quality
13. `.github/kb/langfuse/patterns/python-sdk-integration.md` — Observability traces
...
**KB:** `.github/kb/shadowtraffic/patterns/ecommerce-postgres.md`
...
**KB:** `.github/kb/pydantic/concepts/base-model.md`
...
**KB:** `.github/kb/llamaindex/patterns/jsonl-to-qdrant.md`
...
**KB:** `.github/kb/langchain/patterns/react-agent-dual-tools.md`
...
**KB:** `.github/kb/chainlit/patterns/langchain-integration.md`
**Output:** Chainlit app with streaming + tool step visibility

### Capability 6: CrewAI Crew (Day 4)

**When:** User needs multi-agent crew
**KB:** `.github/kb/crewai/concepts/agents.md`, `.github/kb/crewai/concepts/crews.md`
...
**KB:** `.github/kb/deepeval/patterns/agent-evaluation.md`
