...
1. `.github/kb/aide-slides/quality-rules.md` — Rules that constrain layout decisions
2. `.github/kb/aide-slides/slide-types.md` — The 14 slide type taxonomy
3. `.github/kb/aide-slides/advanced-visuals.md` — Visual pattern options (when to use each)
4. Palette file:
   - If deck is `d1-d4`: `.github/kb/aide-slides/semana-palette.md`
   - If deck is `l0/l1`: `.github/kb/aide-slides/design-system.md`
