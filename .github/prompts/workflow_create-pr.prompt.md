---
description: "Migrated workflow command for phase create-pr."
agent: "agent"
tools: [execute, read]
---
...
Invoke this prompt from the Copilot Chat prompt picker (type `/` in chat and select `workflow_create-pr`).
...
```bash
/workflow_create-pr "refactor(agents): standardize agent definitions"
...
```bash
/workflow_create-pr --review

# Running CodeRabbit analysis...
# ✅ No critical issues
# ⚠️ 2 warnings (code style)
#
# Running Copilot deep review...
...
- Review Command: `.github/prompts/review.prompt.md`
- Dual Reviewer Agent: `.github/agents/code-quality/dual-reviewer.agent.md`
