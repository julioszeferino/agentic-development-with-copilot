...
| File | Purpose |
|------|---------|
| `.github/prompts/dev.prompt.md` | Command definition |
| `.github/agents/dev/prompt-crafter.agent.md` | PROMPT crafting agent |
| `.github/agents/dev/dev-loop-executor.agent.md` | Execution agent |
